...
export class CreateCheckinPage extends BasePage {
  ...
  private quadrantScreen = {
    title:
      'new UiSelector().text("Tap the color that best describes how you feel right now")',
  ...
  private journalEntryScreen = {
    title:
      'new UiSelector().textContains("Describe what might be causing you to feel")',
  ...
  private checkinCompletedScreen = {
    ...
    firstTimeToolTip:
      'new UiSelector().textContains("Want to change how you feel")',
  };
  ...
  async selectPreviousDateInCarousel(): Promise<void> {
    ...
    // SWIPE DOWN to select previous date in ∂ate carousel
